    ...
    public static class Captain
    {
        public static ActorData Data()
        {
            return new ActorData
            {
                ...
                {
                    { 5, new StatGrowth { Strength = 1.8f, Vitality = 1.5f, Agility = 0.9f, Stamina = 1.1f, Intelligence = 0.6f, Wisdom = 0.6f, Luck = 0.8f } },
                    { 10, new StatGrowth { Strength = 2.3f, Vitality = 2.0f, Agility = 1.1f, Stamina = 1.3f, Intelligence = 0.8f, Wisdom = 0.8f, Luck = 1.0f } },
                    { 20, new StatGrowth { Strength = 2.9f, Vitality = 2.5f, Agility = 1.5f, Stamina = 1.7f, Intelligence = 1.0f, Wisdom = 1.0f, Luck = 1.2f } },
                    { 40, new StatGrowth { Strength = 3.8f, Vitality = 3.5f, Agility = 2.1f, Stamina = 2.1f, Intelligence = 1.5f, Wisdom = 1.5f, Luck = 1.8f } }
                },
