    ...
    public static class Paladin
    {
        public static ActorData Data()
        {
            return new ActorData
            {
                ...
                {
                    { 5, new StatGrowth { Strength = 0.9f, Vitality = 1.9f, Agility = 0.5f, Stamina = 1.4f, Intelligence = 0.5f, Wisdom = 1.2f, Luck = 0.5f } },
                    { 10, new StatGrowth { Strength = 1.2f, Vitality = 2.3f, Agility = 0.8f, Stamina = 1.8f, Intelligence = 1.0f, Wisdom = 1.6f, Luck = 1.0f } },
                    { 20, new StatGrowth { Strength = 1.7f, Vitality = 2.8f, Agility = 1.0f, Stamina = 2.3f, Intelligence = 1.5f, Wisdom = 2.0f, Luck = 1.5f } },
                    { 40, new StatGrowth { Strength = 2.7f, Vitality = 3.8f, Agility = 1.5f, Stamina = 3.2f, Intelligence = 2.0f, Wisdom = 2.8f, Luck = 2.0f } }
                },
