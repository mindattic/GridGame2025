    ...
    private static void Load()
    {
        ...
        visualEffects = new Dictionary<string, VFXAsset>
        {
            { "AcidSplash", new VFXAsset
                {
                Name = "AcidSplash",
                Prefab = AssetHelper.LoadAsset<GameObject>($"Vfx/AcidSplash"),
            ...
            { "AirSlash", new VFXAsset
                {
                Name = "AirSlash",
                Prefab = AssetHelper.LoadAsset<GameObject>($"Vfx/AirSlash"),
            ...
            {
                Name = "BloodClaw",
                Prefab = AssetHelper.LoadAsset<GameObject>($"Vfx/BloodClaw"),
            ...
            { "BlueSlash1", new VFXAsset
                {
                Name = "BlueSlash1",
                Prefab = AssetHelper.LoadAsset<GameObject>($"Vfx/BlueSlash1"),
                RelativeOffset = new Vector3(0f, 0f, 0f),
            ...
            { "BlueSlash2", new VFXAsset
                {
                Name = "BlueSlash2",
                Prefab = AssetHelper.LoadAsset<GameObject>($"Vfx/BlueSlash2"),
                RelativeOffset = new Vector3(0f, 0f, 0f),
                AngularRotation = new Vector3(0f, 0f, 0f),
                RelativeScale = new Vector3(0.1f, 0.1f, 0.1f),
                Delay = 0f,
            ...
            { "BlueSlash3", new VFXAsset
                {
                Name = "BlueSlash3",
                Prefab = AssetHelper.LoadAsset<GameObject>($"Vfx/BlueSlash3"),
            ...
            { "BlueSword", new VFXAsset
                {
                Name = "BlueSword",
                Prefab = AssetHelper.LoadAsset<GameObject>($"Vfx/BlueSword"),
            ...
            { "BlueSword4X", new VFXAsset
                {
                Name = "BlueSword4X",
                Prefab = AssetHelper.LoadAsset<GameObject>($"Vfx/BlueSword4X"),
            ...
            { "BlueYellowSword", new VFXAsset
                ...
                Prefab = AssetHelper.LoadAsset<GameObject>($"Vfx/BlueYellowSword"),
            ...
            { "BlueYellowSword3X", new VFXAsset
                ...
                Prefab = AssetHelper.LoadAsset<GameObject>($"Vfx/BlueYellowSword3X"),
            ...
            { "BuffLife", new VFXAsset
                {
                Name = "BuffLife",
                Prefab = AssetHelper.LoadAsset<GameObject>($"Vfx/BuffLife"),
                RelativeOffset = new Vector3(0f, 0f, 0f),
                AngularRotation = new Vector3(0f, 0f, 0f),
            ...
            { "DoubleClaw", new VFXAsset
                {
                Name = "DoubleClaw",
                Prefab = AssetHelper.LoadAsset<GameObject>($"Vfx/DoubleClaw"),
            ...
            { "FireRain", new VFXAsset
                {
                Name = "FireRain",
                Prefab = AssetHelper.LoadAsset<GameObject>($"Vfx/FireRain"),
            ...
            { "GodRays", new VFXAsset
                {
                Name = "GodRays",
                Prefab = AssetHelper.LoadAsset<GameObject>($"Vfx/GodRays"),
            ...
            { "GoldBuff", new VFXAsset
                {
                Name = "GoldBuff",
                Prefab = AssetHelper.LoadAsset<GameObject>($"Vfx/GoldBuff"),
                RelativeOffset = new Vector3(0f, 0f, 0f),
                AngularRotation = new Vector3(0f, 0f, 0f),
            ...
            { "GreenBuff", new VFXAsset
                {
                Name = "GreenBuff",
                Prefab = AssetHelper.LoadAsset<GameObject>($"Vfx/GreenBuff"),
            ...
            { "HexShield", new VFXAsset
                {
                Name = "HexShield",
                Prefab = AssetHelper.LoadAsset<GameObject>($"Vfx/HexShield"),
                RelativeOffset = new Vector3(0f, 0f, 0f),
                AngularRotation = new Vector3(0f, 0f, 0f),
            ...
            { "LevelUp", new VFXAsset
                {
                Prefab = AssetHelper.LoadAsset<GameObject>($"Vfx/LevelUp"),
                Name = "LevelUp",
            ...
            { "LightningExplosion", new VFXAsset
                ...
                Prefab = AssetHelper.LoadAsset<GameObject>($"Vfx/LightningExplosion"),
            ...
            { "LightningStrike", new VFXAsset
                ...
                Prefab = AssetHelper.LoadAsset<GameObject>($"Vfx/LightningStrike"),
            ...
            { "MoonFeather", new VFXAsset
                {
                Name = "MoonFeather",
                Prefab = AssetHelper.LoadAsset<GameObject>($"Vfx/MoonFeather"),
            ...
            { "OrangeSlash", new VFXAsset
                {
                Name = "OrangeSlash",
                Prefab = AssetHelper.LoadAsset<GameObject>($"Vfx/OrangeSlash"),
            ...
            { "PinkSpark", new VFXAsset
                {
                Name = "PinkSpark",
                Prefab = AssetHelper.LoadAsset<GameObject>($"Vfx/PinkSpark"),
                RelativeOffset = new Vector3(0f, 0f, 0f),
                AngularRotation = new Vector3(0f, 0f, 0f),
            ...
            { "PuffyExplosion", new VFXAsset
                {
                Name = "PuffyExplosion",
                Prefab = AssetHelper.LoadAsset<GameObject>($"Vfx/PuffyExplosion"),
            ...
            { "RayBlast", new VFXAsset
                {
                Name = "RayBlast",
                Prefab = AssetHelper.LoadAsset<GameObject>($"Vfx/RayBlast"),
            ...
            { "RedSlash2X", new VFXAsset
                {
                Name = "RedSlash2X",
                Prefab = AssetHelper.LoadAsset<GameObject>($"Vfx/RedSlash2X"),
            ...
            { "RedSword", new VFXAsset
                {
                Name = "RedSword",
                Prefab = AssetHelper.LoadAsset<GameObject>($"Vfx/RedSword"),
            ...
            { "RotaryKnife", new VFXAsset
                {
                Name = "RotaryKnife",
                Prefab = AssetHelper.LoadAsset<GameObject>($"Vfx/RotaryKnife"),
                RelativeOffset = new Vector3(0.03f, -0.05f, 0f),
                AngularRotation = new Vector3(0f, 0f, 0f),
            ...
            { "ToxicCloud", new VFXAsset
                {
                Name = "ToxicCloud",
                Prefab = AssetHelper.LoadAsset<GameObject>($"Vfx/ToxicCloud"),
                RelativeOffset = new Vector3(-0.02f, 0f, 0f),
                AngularRotation = new Vector3(0f, 0f, 0f),
                RelativeScale = new Vector3(0.15f, 0.15f, 0.15f),
                Delay = 0f,
            ...
            { "YellowHit", new VFXAsset
                {
                Name = "YellowHit",
                Prefab = AssetHelper.LoadAsset<GameObject>($"Vfx/YellowHit"),
                RelativeOffset = new Vector3(-0.02f, 0f, 0f),
                AngularRotation = new Vector3(0f, 0f, 0f),
                RelativeScale = new Vector3(0.2f, 0.2f, 0f),
                Delay = 0f,
            ...
            //Loops
              ...
              { "BlueGlow", new VFXAsset
                {
                    Name = "BlueGlow",
                    Prefab = AssetHelper.LoadAsset<GameObject>("Vfx/Loop/BlueGlow"),
            ...
            { "Bubble", new VFXAsset
                {
                    Name = "Bubble",
                    Prefab = AssetHelper.LoadAsset<GameObject>("Vfx/Loop/Bubble"),
                    RelativeOffset = Vector3.zero,
                    AngularRotation = Vector3.zero,
                    RelativeScale = new Vector3(0.1f, 0.1f, 0.1f),
                    Delay = 0f,
            ...
            { "Feather", new VFXAsset
                {
                    Name = "Feather",
                    Prefab = AssetHelper.LoadAsset<GameObject>("Vfx/Loop/Feather"),
                    RelativeOffset = Vector3.zero,
                    AngularRotation = Vector3.zero,
                    RelativeScale = new Vector3(0.1f, 0.1f, 0.1f),
                    Delay = 0f,
            ...
            { "Fireball", new VFXAsset
                {
                    Name = "Fireball",
                    Prefab = AssetHelper.LoadAsset<GameObject>("Vfx/Loop/Fireball"),
                    RelativeOffset = Vector3.zero,
                    AngularRotation = Vector3.zero,
            ...
            { "Flame", new VFXAsset
                {
                    Name = "Flame",
                    Prefab = AssetHelper.LoadAsset<GameObject>("Vfx/Loop/Flame"),
                    RelativeOffset = Vector3.zero,
                    AngularRotation = Vector3.zero,
                    RelativeScale = new Vector3(0.08f, 0.08f, 0.08f),
                    Delay = 0f,
            ...
            { "GoldSparkle", new VFXAsset
                {
                    Name = "GoldSparkle",
                    Prefab = AssetHelper.LoadAsset<GameObject>("Vfx/Loop/GoldSparkle"),
                    RelativeOffset = Vector3.zero,
                    AngularRotation = Vector3.zero,
            ...
            { "GreenSparkle", new VFXAsset
                {
                    Name = "GreenSparkle",
                    Prefab = AssetHelper.LoadAsset<GameObject>("Vfx/Loop/GreenSparkle"),
                    RelativeOffset = Vector3.zero,
                    AngularRotation = Vector3.zero,
            ...
            { "IceSparkle", new VFXAsset
                {
                    Name = "IceSparkle",
                    Prefab = AssetHelper.LoadAsset<GameObject>("Vfx/Loop/IceSparkle"),
                    RelativeOffset = Vector3.zero,
                    AngularRotation = Vector3.zero,
                    RelativeScale = new Vector3(0.1f, 0.1f, 0.1f),
                    Delay = 0f,
            ...
            { "PinkDust", new VFXAsset
                {
                    Name = "PinkDust",
                    Prefab = AssetHelper.LoadAsset<GameObject>("Vfx/Loop/PinkDust"),
                    RelativeOffset = Vector3.zero,
                    AngularRotation = Vector3.zero,
                    RelativeScale = new Vector3(0.1f, 0.1f, 0.1f),
                    Delay = 0f,
            ...
            { "RosePetal", new VFXAsset
                {
                    Name = "RosePetal",
                    Prefab = AssetHelper.LoadAsset<GameObject>("Vfx/Loop/RosePetal"),
                    RelativeOffset = Vector3.zero,
                    AngularRotation = Vector3.zero,
                    RelativeScale = new Vector3(0.1f, 0.1f, 0.1f),
                    Delay = 0f,
            ...
            { "StarSparkle", new VFXAsset
                {
                    Name = "StarSparkle",
                    Prefab = AssetHelper.LoadAsset<GameObject>("Vfx/Loop/StarSparkle"),
                    RelativeOffset = Vector3.zero,
                    AngularRotation = Vector3.zero,
                    RelativeScale = new Vector3(0.1f, 0.1f, 0.1f),
                    Delay = 0f,
