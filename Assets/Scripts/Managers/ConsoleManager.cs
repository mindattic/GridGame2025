...
namespace Game.Behaviors
{
    public class ConsoleManager : MonoBehaviour
    {
        ...
        private void FixedUpdate()
        {
            ...
            //string attackers = battle.attackers.Any() ? $"[{string.Join(",", battle.attackers.GetProfile(x => x.character))}]" : "-";
            //string supports = battle.supporters.Any() ? $"[{string.Join(",", battle.supporters.GetProfile(x => x.character))}]" : "-";
            //string defenders = battle.defenders.Any() ? $"[{string.Join(",", battle.defenders.GetProfile(x => x.character))}]" : "-";
