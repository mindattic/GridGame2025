    ...
    public static class Barbarian
    {
        public static ActorData Data()
        {
            return new ActorData
            {
                ...
                {
                    { 5,  new StatGrowth { Strength = 1.8f, Vitality = 1.8f, Agility = 0.6f, Speed = 0.9f, Stamina = 1.1f, Intelligence = 0.3f, Wisdom = 0.4f, Luck = 0.5f } },
                    { 10, new StatGrowth { Strength = 2.1f, Vitality = 2.0f, Agility = 0.7f, Speed = 1.0f, Stamina = 1.5f, Intelligence = 0.5f, Wisdom = 0.5f, Luck = 0.6f } },
                    { 15, new StatGrowth { Strength = 2.4f, Vitality = 2.3f, Agility = 0.8f, Speed = 1.2f, Stamina = 1.9f, Intelligence = 0.6f, Wisdom = 0.6f, Luck = 0.8f } },
                    { 20, new StatGrowth { Strength = 2.7f, Vitality = 2.6f, Agility = 1.0f, Speed = 1.4f, Stamina = 2.2f, Intelligence = 0.8f, Wisdom = 0.7f, Luck = 1.0f } }
                },
