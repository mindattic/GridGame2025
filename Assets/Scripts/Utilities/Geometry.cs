...
public class Geometry
{
    ...
    private static TileMap tileMap => GameManager.instance.tileMap;               // The TileMap _instance storing tile data.
    ...
    /// <summary>
    /// Finds the tile _instance closest to a given world position.
    /// </summary>
    ...
    /// <summary>
    /// Finds the tile _instance at a specified grid location.
    /// </summary>
